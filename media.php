...
<body>
    ...
    <main id="js-page-content" role="main" class="page-content mt-3">
        ...
        <form action="media_handler.php?id=<?php echo $current_id ?>" method="post" enctype="multipart/form-data">
            <div class="row">
                <div class="col-xl-6">
                    ...
                    ?>
                            ...
                            <div class="panel-content">
                                <div class="form-group">
                                    <img src="img/<?php echo $current_user['avatar']?>" alt="" class="img-responsive" width="200">
                                </div>
